...
// detection related 检测
DEFINE_string(image_dir, "", "Dir of input image.");
DEFINE_string(det_model_dir, "inference/ch_PP-OCRv2_det_infer", "Path of det inference model.");
...
// recognition related 识别
DEFINE_string(rec_model_dir, "inference/ch_PP-OCRv2_rec_infer", "Path of rec inference model.");
